...
import desainRumahData from 'data/desainRumahData'
...
function DesainRumah() {
  ...
  // Split the desainRumahData into arrays with 4 items each
  ...
  const desainRumahDataRows = splitDataIntoRows(
    desainRumahData.slice(0, visibleItems),
    4,
  )
    ...
    <>
      ...
      <div className="mx-[110px] md:justify-center md:flex">
        ...
        <div className="flex justify-evenly flex-wrap gap-x-px ">
          {desainRumahDataRows.map((row, index) => (
